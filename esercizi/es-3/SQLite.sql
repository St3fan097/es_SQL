...
ALTER TABLE Books
DROP COLUMN gender;   /* avevo sbaglio nell'esercizio precedente il nome e il tipo della colonna */
...
INSERT INTO Books (book_id, title, author, genre, published_year, isbn, price, rating, stock_count, publisher, number_of_pages)
VALUES (4, 'The Galactic Odyssey', 'Orion Starfield', 'Fiction', 2005, '1234567890126', 19.99, 4.9, 15, 'Nebula Press', 450);
